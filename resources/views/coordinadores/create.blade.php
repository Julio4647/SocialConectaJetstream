            ...
            <div class="bg-white ">
                <div class="p-4 sm:ml-64">
                    <div class="p-4  dark:border-gray-700 mt-14">
                        <button onclick="window.location='{{ route('cordinador') }}'"
                            ...
                            <img src="{{ asset('img/regreso.svg') }}" alt="" class="w-4 h-4 mr-2 inline-block">
                        </button>
                        <div class="flex justify-center py-4">
                            <h2 class="text-xl md:text-2xl lg:text-3xl xl:text-4xl mt-4 md:mt-6 lg:mt-8 xl:mt-10">Asignar Agency Manager a Coordinador</h2>
                        </div>
                        <form action="{{ route('coordinador.register') }}" method="POST" class="flex flex-wrap justify-center">
                            @csrf
                            <div class="w-full p-1">
                                <label for="agency_id">Agency Manager:</label>
                                <select name="agency_id" required class="w-full rounded-md border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
