...
<html lang="en">
    <head><link href="https://fonts.googleapis.com/css?family=Varela+Round" rel="stylesheet">
        ...
        <body>
            <div class="message">Opppps... <br>
                Tu no estas Autorizado</div>
            <div class="container">
            ...
            <!-- Agrega el botón "Regresar" aquí -->
            <button class="message2"  onclick="goBack()">Regresar</button>
