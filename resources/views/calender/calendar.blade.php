    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                locale: 'es', // Español
                initialView: 'dayGridMonth', // Cambiando la vista a mes
                eventColor: 'gray',
                resources: [
                    {id: 'a', title: 'Sala A'},
                    {id: 'b', title: 'Sala B'}
                ...
                eventDrop: function (info) {
                    if (!confirm("Has solicitado cambiar el evento: " + info.event.title +
                        "\nEl evento será cambiado a la fecha: " + moment(info.event.startStr).format(
                            'DD-MM-YYYY HH:mm:ss')))
                    {
                        info.revert();
                    } else {
...
<body>
    ...
    <div class="">
        <div class="">
            <div class="col-md-6 col-12" id="calendar-container">
                <div id="calendar"></div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <form method="post" action="{{route('calendar.store')}}">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="exampleColorInput" class="form-label">Color nota</label>
                        <input type="color" name="color" class="form-control form-control-color"
                               id="create-color" value="#563d7c"
                               title="Choose your color" required>
                    </div>
                    <div class="mb-3">
                        <label for="exampleColorInput" class="form-label">Estatus</label>
                    ...
                    <div class="mb-3">
                        <label for="exampleColorInput" class="form-label">Recurso</label>
